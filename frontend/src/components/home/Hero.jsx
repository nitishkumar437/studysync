  ...
  return (
    <section className="bg-linear-to-b from-indigo-50 via-white to-white">
      <div className="max-w-7xl mx-auto px-6 pt-24 pb-20">
        ...
        <h1 className="mt-8 text-center text-5xl md:text-7xl font-extrabold leading-tight">
        ...
        <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-5">
          ...
          <a
            href="#dashboard"
            className="px-7 py-4 rounded-xl border border-gray-300 font-semibold hover:bg-gray-100 transition"
          >
            View Demo
          </a>
        </div>
